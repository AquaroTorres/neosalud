...
<p class="text-muted mt-4">Bienvenido al portal interno NeoSalud </p>
...
<div class="card-deck mb-3">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <a class="btn-cu btn-m btn-color-estandar m-auto" href="{{ route('claveunica.login') }}"
...
<footer class="pt-4 my-md-5 pt-md-5 border-top">
    <div class="row">
        <div class="col-3 col-md-3">
            {{-- <img class="mb-2" src="{{ asset('images/logo_sst_100px.png') }}" alt="Logo Servicio de Salud"> --}}
        </div>
